        ...
        _this.daemon.batchCmd(batchRpcCalls, function (error, results) {
            ...
            options.poolAddressScript = (function () {
                switch (options.coin.reward) {
                    ...
                    case 'POW':
                        var miningAddress = rpcResults.validateaddress.address;
                        if (miningAddress !== options.address) {
                            miningAddress = options.address;
                        }
                        return util.addressToScript(miningAddress);
                }
            })();
